...
RUN mkdir /tmp/gofabric8 && curl --retry 999 --retry-max-time 0  -sSL https://github.com/fabric8io/gofabric8/releases/download/v0.4.15/gofabric8-0.4.15-linux-amd64.tar.gz | tar xzv -C /tmp/gofabric8 && \
